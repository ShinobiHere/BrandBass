        ...
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold">Our Newest Products</h2>
                    
                    <Link href="/products" className="flex text-primary items-center gap-x-1">
                        See All{" "}
                        <span><ArrowRight /></span>
                    </Link>
                    {/* <Link href="/all-products" className="flex text-primary items-center gap-x-1">
                        See All{" "}
                        <span><ArrowRight /></span>
                    </Link> */}
                </div>
